					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="P_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into patient(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,search_per) values(?,?,?,?,?,?,?,?,?,?,?,?)");
