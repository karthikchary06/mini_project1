...
try 
	{		
            ...
            <tr>
              ...
              <td width="90" bgcolor="#FF0000"><div align="center" class="style26">Patient</div></td>
              <td width="67" bgcolor="#FF0000"><div align="center" class="style26">Doctor</div></td>
              <td width="122" bgcolor="#FF0000"><div align="center" class="style26">Scheduled D&amp;T</div></td>
              <td width="75" bgcolor="#FF0000"><div align="center" class="style26">Amount </div></td>
              <td width="129" bgcolor="#FF0000"><div align="center" class="style26">Details/File </div></td>
              <td width="91" bgcolor="#FF0000"><div align="center" class="style26">Bill </div></td>
            </tr>
            <%			

			String pname=(String)application.getAttribute("pname");

				String query="Select *from bill where status='Pending' and patient='"+pname+"' "; 
				...
				while ( rs.next() )
				{
					...
					String query1="Select *from files where patient='"+s2+"' and fname='"+s4+"' "; 
					...
					{		
						...
						<tr>
						  ...
						  <td><div align="center"><%=s2%> (<%=disease%>)</div></td>
						  <td><div align="center"><%=s3%></div></td>
						  <td><div align="center"><%=s5%></div></td>
						  <td><div align="center"><%=s6%></div></td>
						  <td><div align="center"><%=s4%></div></td>
						  <td><div align="center"><a href="P_MakePayment1.jsp?id=<%=i%>">Make Payment </a></div></td>
						</tr>
						<%	
					}	
				}
