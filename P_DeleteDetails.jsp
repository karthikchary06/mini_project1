...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2">Delete Uploaded Details !!!</h2>
...
try 
	{		
				...
				%>
            <tr>
              <td width="40" height="30" bgcolor="#FF0000"><div align="center" class="style21 style25"><strong> ID </strong></div></td>
              <td width="104" bgcolor="#FF0000"><div align="center" class="style27">Details/File  </div></td>
              <td width="130" bgcolor="#FF0000"><div align="center" class="style27">Hospital</div></td>
              <td width="151" bgcolor="#FF0000"><div align="center" class="style27">Doctor</div></td>
              <td width="136" bgcolor="#FF0000"><div align="center" class="style27">Delete </div></td>
            </tr>
            <%
            ...
            <tr>
			  ...
			  <td><div align="center"><a href="P_DeleteDetails1.jsp?fname=<%=s2%>">Delete</a></div></td>
            </tr>
            <%
