...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div>
          <h2><span>Manage Bank Account </span></h2>
          <p><span class="style2">Role : (Patient)</span></p>
          <p>&nbsp;</p>
          <ul class="sb_menu">
            <li><strong><a href="P_AddAccount.jsp">Add Account </a></strong></li>
            <li><strong><a href="P_ViewAccount.jsp">View Account </a></strong></li>
            <li><strong><a href="P_DeleteAccount.jsp">Delete Account </a></strong></li>
            <li><strong><a href="P_UpdateAccount.jsp">Update  Account </a></strong></li>
          </ul>
