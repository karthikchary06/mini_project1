      ...
      <div class="mainbar">
        <div >
		  ...
		  %>
		                  ...
		                  <form id="form1" name="form1" method="post" action="P_UpdateAccount1.jsp">

		  <p class="style19">Account : <%=found%></p>
		  
		  <table width="441" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" bgcolor="#FFFF00"><span class="style20">Bank : </span></td>
              <td><input type="text" name="bank" disabled="disabled" value="<%=bank%>" /></td>
            </tr>
			<input type="hidden" name="id" value="<%=i%>" />
            <tr>
              <td height="25" bgcolor="#FFFF00"><span class="style20">Branch : </span></td>
              <td><input type="text" name="branch" disabled="disabled"  value="<%=branch%>"/></td>
            </tr>
            <tr>
              <td width="132" height="25" bgcolor="#FFFF00"><span class="style20">Account No : </span></td>
              <td width="165"><input type="text" name="accno"   disabled="disabled" value="<%=accno%>"/></td>
            </tr>
            <tr>
              <td height="25" bgcolor="#FFFF00"><span class="style20">Mobile No : </span></td>
              <td><input type="text" name="mobno" disabled="disabled" value="<%=mobno%>"/></td>
            </tr>


            <tr>
              <td height="25" bgcolor="#FFFF00"><span class="style20">E-mail : </span></td>
              <td><input type="text" name="email" disabled="disabled" value="<%=email%>"/></td>
            </tr>

            <tr>
              <td height="25" bgcolor="#FFFF00"><span class="style20">Available Balance : </span></td>
              <td><input type="text" name="amount" disabled="disabled" value="<%=tot_bal%>"/></td>
            </tr>
			
			<tr>
			  <td height="25" bgcolor="#FFFF00"><span class="style20">Add Amount : </span></td>
			  <td><label>
			    <input type="text" name="new_amt" />
			  </label></td>
              </tr>
			...
			<tr>
			 ...
			 <tr>
              <td bgcolor="#CC3300"><label>
                    <div align="center">
                      <input type="submit" name="Submit" value="Update Amount" />
                  </div>
              </label>               </td>
            </tr>
          </table>
