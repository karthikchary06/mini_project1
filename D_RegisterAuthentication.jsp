...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("department"))
							{
								department=multi.getParameter(paramname);
							}
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from doctor  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Doctor Name Already Exits");							
							%>
							<p><a href="D_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into doctor(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,d_hospital,d_department) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
