...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div>
          <h2 class="style4">Patient Register !!!</h2>
          <p class="style4"><img src="images/Register.jpg"/A Three Layer Privacy Preserving Cloud Storage Scheme/images/Register.jpg" width="301" height="166" /></p>
          <form action="P_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
            ...
            <table width="590" height="524" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td bgcolor="#FF0000" scope="row"><span class="style3">
                  ...
                  <div align="left" class="style3">Your Address : </div>
                  <span class="style3">
                  </label>
                </span></td>
