...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="P_autho.jsp">Patient</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Hi <%=application.getAttribute("pname")%> !! (Patient)  </span></h2>
          <p>&nbsp;</p>
          <p class="style18">You Are <span class="style11">Not Authorized</span> .. </p>
          <p class="style18 style19">Please Wait For Cloud To Authorize You !! </p>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			<li><a href="P_autho.jsp">Patient</a></li>
			<li><a href="P_Login.jsp">Logout</a></li>
          </ul>
        </div>
